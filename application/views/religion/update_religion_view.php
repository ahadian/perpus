...
<?php
foreach($religion->result() as $detail){
?>
<div class="box-content padded">
		<div class="tab-content">
                <div class="box-content" id="list">
                    <form name="form1" method="post" action="<?= base_url() ?>religion/updatereligionDb" class="form-horizontal">
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label">Religion</label>
                                <div class="controls">
                                    <input type="hidden" value="<?php echo $detail->id; ?>" class="span3" name="id" />
                                    <input type="text" class="span3" name="agama" value="<?php echo $detail->agama; ?>"/>
                                </div>
                            </div>
