...
<?php
$i = $this->db->query("SELECT * FROM config LIMIT 1")->row();
...
<table width="100%">
<tr>
<td style="width: 18mm"><img src="<?=base_URL()?>img/<?=$i->logo?>" style="width: 50px; height: 50px"></td>
...
<tr><td rowspan="5"><img src="<?=$d->foto?>" style="width: 60px; height: 80px"></td><td>Nama</td><td>:</td><td> <b><?=$d->nama?></b></td></tr>
...
<tr><td>T T L</td><td>:</td><td><b><?=$d->tmp_lahir.", ".tgl_indo($d->tgl_lahir)?></b></td></tr>
